...
public interface HttpRetryExecutors {
    /**
     ...
     * @throws Exception
     */
    <T> T executor(Task<T> task, Retryer retryer, Retryer.RetryMeta retryMeta) throws Exception;
     ...
     * @throws Exception
     */
    <T> T executor(Task<T> task, boolean needRetry) throws Exception;
